...
class Settings
{
    ...
    public function registrarConfiguracoes(): void
    {
        ...
        register_setting($group, 'map_image_model', ['sanitize_callback' => [$this, 'sanitizarModeloImagem']]);
        register_setting($group, 'map_image_style', ['sanitize_callback' => [$this, 'sanitizarEstiloImagem']]);
        register_setting($group, 'map_image_resolution', ['sanitize_callback' => [$this, 'sanitizarResolucaoImagem']]);
        register_setting($group, 'map_image_quality', ['sanitize_callback' => [$this, 'sanitizarQualidadeImagem']]);
        ...
        register_setting($group, 'map_seo_metadados', 'sanitize_textarea_field');
        register_setting($group, 'map_seo_tags_extra', 'sanitize_text_field');
    }
